...
import { LayoutDashboard, ShoppingBag, UtensilsCrossed, ExternalLink, ChevronRight } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-[#0d0400] overflow-hidden">
      {/* Sidebar */}
      <aside className="w-64 bg-[#140800] border-r border-orange-900/30 flex flex-col shrink-0">
        {/* Logo */}
