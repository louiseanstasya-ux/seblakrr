...
const SECTIONS = ["Seblak", "Topping", "Minuman"];
...
const MOCK_MENU: MenuItem[] = [
  ...
  { _id: "topping-001", merchantId: "seblakrr", title: "Nasi Goreng Telur", description: "Nasi goreng wangi dengan bumbu spesial, telur mata sapi di atasnya, dan kerupuk renyah.", price: 15000, quantity: 100, section: "Topping", image: "/menu-images/nasi_goreng.png", createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: "topping-002", merchantId: "seblakrr", title: "Nasi Goreng Sosis", description: "Nasi goreng bumbu spesial dengan irisan sosis sapi/ayam yang melimpah, disajikan panas.", price: 18000, quantity: 100, section: "Topping", image: "/menu-images/nasi_goreng.png", createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: "topping-003", merchantId: "seblakrr", title: "Rice Bowl Nugget Sambal Matah", description: "Nasi putih hangat dengan nugget goreng krispi dan sambal matah segar khas Bali di atasnya.", price: 18000, quantity: 100, section: "Topping", image: "/menu-images/rice_bowl.png", createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: "topping-004", merchantId: "seblakrr", title: "Rice Bowl Ayam Daun Jeruk", description: "Nasi putih dengan ayam goreng bumbu daun jeruk yang harum dan crispy.", price: 18000, quantity: 100, section: "Topping", image: "/menu-images/rice_bowl.png", createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: "topping-005", merchantId: "seblakrr", title: "Kentang Goreng", description: "Kentang goreng renyah di luar, lembut di dalam. Disajikan dengan saus sambal & mayones.", price: 10000, quantity: 100, section: "Topping", image: "/menu-images/kentang_goreng.png", createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: "topping-006", merchantId: "seblakrr", title: "Pisang Keju Susu", description: "Pisang goreng crispy topping keju parut dan susu kental manis.", price: 10000, quantity: 100, section: "Topping", image: "/menu-images/pisang_goreng.png", createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { _id: "topping-007", merchantId: "seblakrr", title: "Pisang Coklat Meses", description: "Pisang goreng crispy dibalut coklat leleh dan ditaburi meses warna-warni.", price: 10000, quantity: 100, section: "Topping", image: "/menu-images/pisang_goreng.png", createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
