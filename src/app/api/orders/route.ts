...
export async function POST(req: NextRequest) {
    try {
        ...
        const { merchantId, items, amount } = body;
        
        // For anonymous QR users, we might not have a userId. Use a dummy or optional one.
        // But the schema requires userId. We'll use merchantId as a placeholder if userId is missing.
        ...
        return sendRJResponse({ success: true, status: 201, data: order, message: "Order created successfully" });
    } catch (error) {
...
export async function PUT(req: NextRequest) {
    try {
        ...
        return sendRJResponse({ success: true, status: 200, data: order, message: "Order updated successfully" });
    } catch (error) {
...
export async function DELETE(req: NextRequest) {
    try {
        ...
        return sendRJResponse({ success: true, status: 200, data: null, message: "Order deleted successfully" });
    } catch (error) {
